                        ...
                        <div class="ibox-title">
                            ...
                            <?php
                                ...
                                if($id_pro===""){
                                    ...
                                    $sql_data_dosen = $koneksi->query("SELECT * FROM tb_dosen INNER JOIN tb_prodi ON tb_prodi.id_prodi=tb_dosen.id_prodi WHERE id_fakultas='$id_fak' ORDER BY nama_dosen ASC");
                                }else{
                                    $sql_data_prodi = $koneksi->query("SELECT * FROM tb_prodi WHERE id_prodi='$id_pro' ORDER BY nama_prodi ASC");
                                    $sql_data_dosen = $koneksi->query("SELECT * FROM tb_dosen INNER JOIN tb_prodi ON tb_prodi.id_prodi=tb_dosen.id_prodi WHERE tb_dosen.id_prodi='$id_pro' AND id_fakultas='$id_fak' ORDER BY nama_dosen ASC");
                                }
                            ?>
                        </div>
                                                                ...
                                                                <div class="ibox ">
                                                                    <div class="ibox-content">
                                                                        <form action="../../aksi/edit_dosen.php" method="POST">
                                                                            ...
                                                                            <div class="form-group row"><label class="col-lg-4 col-form-label">NIP</label>
                                                                                <div class="col-lg-8">
                                                                                    <input type="text" hidden value="<?php echo $data_dosen['nip'] ?>" name="nip" placeholder="NIP" class="form-control">
                                                                                    <input type="text" disabled value="<?php echo $data_dosen['nip'] ?>" name="" placeholder="NIP" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row"><label class="col-lg-4 col-form-label">Nama Dosen</label>
