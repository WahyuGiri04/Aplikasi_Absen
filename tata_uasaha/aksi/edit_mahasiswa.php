...
<?php
   ...
   $edit_mahasiswa = $koneksi->query("UPDATE `tb_mahasiswa` SET nim = '$nim', nama_mahasiswa = '$nama_mahasiswa', id_prodi = '$prodi', id_kelas = '$kelas' WHERE id_mahasiswa = '$id_mahasiswa'");

   if($edit_mahasiswa===true){
      echo '<script>
         swal({
