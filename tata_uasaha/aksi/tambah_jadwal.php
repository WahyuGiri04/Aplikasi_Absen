...
<?php
   ...
   $tambah_jadwal = $koneksi->query("INSERT INTO tb_jadwal SET id_makul = '$id_makul', waktu_mulai = '$jam_mulai', waktu_selesai = '$jam_selesai', id_kelas = '$id_kelas', id_ruangan = '$id_ruangan', hari = '$hari', id_dosen = '$id_dosen'");
  
   $sql_jadwal = $koneksi->query("SELECT * FROM tb_jadwal ORDER BY id_jadwal DESC LIMIT 1");
