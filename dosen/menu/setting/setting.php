                        ...
                        <div class="row">
                            <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">Setting pengguna Admin</h3>
                                ...
                                <form method = "POST" action = "../../aksi/ubah_admin.php" role="form">
                                    ...
                                    <input hidden name = "username" type="text" value = "<?php echo $user['username'] ?>" placeholder="Masukkan Username" class="form-control">
                                    <div class="form-group"><label>Username</label> <input disabled type="text" value = "<?php echo $user['username'] ?>" placeholder="Masukkan Username" class="form-control"></div>
                                    <div class="form-group"><label>Nama Pengguna</label> <input disabled name = "nama_pengguna" type="text" value = "<?php echo $user['nama_pengguna'] ?>" placeholder="Masukkan Nama Pengguna" class="form-control"></div>
                                    <div class="form-group"><label>Password Lama</label> <input name = "password" type="password" placeholder="Password" class="form-control"></div>
                                    <div class="form-group"><label>Password Baru</label> <input name = "password_baru" type="password" placeholder="Password" class="form-control"></div>
                                    <div class="form-group"><label>Konfirmasi Password Lama</label> <input name = "konfir_password" type="password" placeholder="Password" class="form-control"></div>
                                    <div>
                            ...
                            <div class="col-sm-6"><h4>Setting akun</h4>
                                <p><?php echo strtoupper($user['nama_pengguna']) ?></p>
                                <p class="text-center">
