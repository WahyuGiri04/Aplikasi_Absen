                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <a type="button" class="btn btn-primary" href = "detail_print.php?id_jadwal=<?php echo $id_jadwal ?>&nama_makul=<?php echo $nama_makul ?>&id_mahasiswa=<?php echo $id_mahasiswa ?>" target = "_blank">
