                    ...
                    <div class="ibox ">
                        <div class="ibox-title">                            
                            <?php
                                ...
                                $sql_dosen = $koneksi->query("SELECT * FROM tb_dosen WHERE nip = '$nip'");
                                $dosen = $sql_dosen->fetch_assoc();
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $sql_data_jadwal = $koneksi->query("SELECT * FROM tb_jadwal INNER JOIN tb_makul ON tb_makul.id_makul=tb_jadwal.id_makul INNER JOIN tb_dosen ON tb_dosen.id_dosen=tb_jadwal.id_dosen INNER JOIN tb_ruangan ON tb_ruangan.id_ruangan=tb_jadwal.id_ruangan INNER JOIN tb_kelas ON tb_kelas.id_kelas=tb_jadwal.id_kelas WHERE tb_dosen.id_dosen = '$id_dosen'");
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td class="center">
                                                <a href="laporan.php?id_jadwal=<?php echo $id_jadwal; ?>" class="btn btn-warning "><i class="fa fa-calendar"> </i> Laporan Absen</a>
                                                <a href="absen.php?id_jadwal=<?php echo $id_jadwal; ?>&nama_makul=<?php echo $data_jadwal['nama_makul'] ?>" class="btn btn-primary "><i class="fa fa-calendar"> </i> Absensi</a>
