            ...
            <div class="row">
                <div class="col-lg-12">
                    <?php
                        ...
                        $nama_kls = $nama_kelas['nama_makul'];
                    ?>
                    <div class="ibox ">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td class="center">
                                                <a href="detail.php?nama_makul=<?php echo $nama_kls; ?>&id_jadwal=<?php echo $id_jadwal; ?>&id_mahasiswa=<?php echo $id_mahasiswa; ?>" class="btn btn-primary "><i class="fa fa-calendar"> </i> Detail Absensi</a>
                                            </td>
                                        </tr>
                                        <?php
                                        }
