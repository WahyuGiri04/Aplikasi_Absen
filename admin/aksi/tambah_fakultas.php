...
<?php
   ...
   if($data_fakultas['jumlah'] > 0){
      ...
      $tambah_fakultas = $koneksi->query("INSERT INTO tb_fakultas SET nama_fakultas = '$nama_fakultas', kode_fakultas = '$kode_fakultas'");

      if($tambah_fakultas===true){
         echo '<script>
            swal({
               title: "Berhasil !!!",
